...
<%
    ...
    URL url = new URL("https://api.flightstats.com/flex/fids/rest/v1/json/" + place + "/departures?appId=668c3ffd&appKey=0af05f95976444ad12c5435935a6221f&codeType=IATA&requestedFields=airlineCode%2CflightNumber%2Ccity%2CcurrentTime%2Cgate%2Cremarks&lateMinutes=15&useRunwayTimes=false&excludeCargoOnlyFlights=false");
...
<br><br><br><table class="table-responsive table-striped table-bordered col-sm-9">
    <caption style="color:black"><b>Departures</b></caption>
    <tr>
        <th>Flight Number</th>
        <th>Airline Code</th>
        <th>Source</th>
    ...
    <%
        for (int i = 0; i < jsonarray.size(); i++) {
            ...
            String src = place;
            String dest = obj1.get("city").toString();
